...
public class EmailService : IEmailService
{
    ...
    public async Task SendHtmlEmailAsync(string to, string subject, string htmlBody)
    {
        ...
        var message = new MailMessage(fromEmail, to, subject, htmlBody)
        {
            IsBodyHtml = true
        };
    ...
    {
        var baseUrl = _config["Email:ConfirmationBaseUrl"];
        var confirmLink = $"{baseUrl}?token={confirmationToken}";
        ...
        await SendHtmlEmailAsync(toEmail, subject, body);
    }
}
